...
namespace TrashCollector2.Controllers
{
    public class CustomersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Address,ZipCode,DayToPickUp,OneTimePickUp,StartOfSuspension,EndOfSupspension,Budget,IdentityUserId")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
